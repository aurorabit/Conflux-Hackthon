    ...
    <div>
        <el-row style="">
            ...
            <el-col :span="12" style="margin-top:2.1%">
                ...
                <el-row  type="flex" style="text-align:center;margin-top:1%;margin-left:30px">
                    <div class="outddl"><div class="ddlBtn">{{nft_info.deadline}}</div></div>
                </el-row>
                <el-row  style="margin-top:6%;margin-left:30px">
                    <el-button class="repayBtn" size="medium" @click="dialogVisible = true"><div class="repay_font">Repayment</div></el-button>
                </el-row>
        ...
        <span slot="footer" class="dialog-footer" style="vertical-align:middle" >
            <el-row  style="text-align:center;vertical-align:middle">
                ...
                <el-col :span="12" style="text-align:center">
                    <button class="cancelBtn" @click="dialogVisible = false"  style="margin-right:30%"><div class="cancelFont">Cancel</div></button>
                </el-col>
            </el-row>
        </span>
        </el-dialog>
        ...
        methods: {
            async getNFTInfo(itemUrl){
                ...
                async function main() {
                    ...
                    _this.nft_info.redeem_price = new Drip(itemInfo[8].toString()).toCFX();
                    let timestamp = itemInfo[10][0];
            ...
            repayConfirm() {
                ...
                async function main() {
                    ...
                    let transaction = await contract
                        ...
                        value: Drip.fromCFX(redeemPrice),
                        gas: 300000
                        }).executed();
