    ...
    <div>
            ...
            <el-col :span="12" style="margin-top:2.1%">
                ...
                <el-row type="flex" style="text-align:left;">
                    <el-col :span="8" style="margin-left:3%;margin-top:50px">
                        ...
                        <el-row style="margin-top:10px"><el-button class="sellBtn" size="medium" @click="dialogVisible_sell = true"><div class="sell_font">SELL</div></el-button></el-row>
                    </el-col>
                    <el-col :span="6" :offset="2" style="margin-left:3%;margin-top:50px">
                        ...
                        <el-row style="margin-top:10px"><el-button class="pawnBtn"  size="medium" @click="dialogVisible_pawn = true"><div class="sell_font">PAWN</div></el-button></el-row>
                    </el-col>
                </el-row>
            </el-col>
        ...
        <el-row  style="margin-top:5%">
            ...
            <el-col :span="11" style="text-align:right;margin-right:2%" class="dialog_font">
                <input style="width:80%;border:none;" class="input_form" v-model="form_sell.sell_price" placeholder="Please enter price here">CFX
            </el-col>
        </el-row>
        </el-form>
         <span slot="footer" class="dialog-footer" style="vertical-align:middle" >
            <el-row  style="text-align:center;vertical-align:middle">
                ...
                <el-col :span="12" style="text-align:center">
                    <button class="cancelBtn" @click="dialogVisible_sell = false"  style="margin-right:30%"><div class="cancelFont">Cancel</div></button>
                </el-col>
            </el-row>
        </span>
        </el-dialog>
        ...
        <el-row  style="margin-top:5%">
            ...
            <el-col :span="11" style="text-align:right;margin-right:2%" class="dialog_font">
                <input style="width:80%;border:none;" class="input_form" v-model="form_pawn.loan_price" placeholder="Please enter price here">CFX
            </el-col>
        </el-row>
        ...
        <el-row  style="margin-top:5%">
            ...
            <el-col :span="11" style="text-align:right;margin-right:2%" class="dialog_font">
                <input style="width:80%;border:none;" class="input_form" v-model="form_pawn.repayment_value" placeholder="Please enter price here">CFX
            </el-col>
        </el-row>
        ...
        <el-row  style="margin-top:5%">
         ...
         <span slot="footer" class="dialog-footer" style="vertical-align:middle" >
            <el-row  style="text-align:center;vertical-align:middle">
                ...
                <el-col :span="12" style="text-align:center">
                    <button class="cancelBtn" @click="dialogVisible_pawn = false"  style="margin-right:30%"><div class="cancelFont">Cancel</div></button>
                </el-col>
            </el-row>
        </span>
        </el-dialog>
        ...
        methods: {
            ...
            async getNFTInfo(itemUrl){
                ...
                async function main() {
                    ...
                    if(itemInfo[7].length > 0)
                        _this.nft_info.loan_price = new Drip(itemInfo[6].toString()).toCFX();
                    else
            ...
            sellConfirm() {
                ...
                // 这里ui输入和对接可能需要利用js-conflux-sdk进行转换
                    ...
                    let sellPrice = Drip.fromCFX(_this.form_sell.sell_price);
                    let loanPrice = Drip.fromCFX(0);
                    // 这里必须是一个整数 是bigNumber
                    let redeemPrice = Drip.fromCFX(0);
                    var now = new Date();
                    let deadline = Math.floor(now.getTime() / 1000 + 60);
                ...
                pawnConfirm() {
                    ...
                    async function main(){
                        ...
                        let itemId = _this.nft_id;
                        // 这里ui输入和对接可能需要利用js-conflux-sdk进行转换
                        let sellPrice = Drip.fromCFX(0);
                        let loanPrice = Drip.fromCFX(_this.form_pawn.loan_price);
                        let redeemPrice = Drip.fromCFX(_this.form_pawn.repayment_value);
                        var now = new Date();
