...
import {MathArtAddress} from "../../sol/config.json";
import {abi} from "../../sol/MathArt.json";
  ...
  methods: {
    ...
    async create() {
      ...
      async function main() {
        ...
        let myAccount = ethers.utils.getAddress(_this.account);
        console.log(myAccount);
        let tokenId = await contract.getCurrentItemId(myAccount);
        console.log(tokenId);
        
        // let transaction = await contract.createToken(_this.json_url)
        //     .sendTransaction({from: _this.account})
        //     .executed();
    ...
    uploadConfirm() {
      ...
      _this.$message.success("Successfully create NFT!");
